...
namespace MyChat.Server.BL.Helpers.IdentityErrorDescriber
{
    public class CustomIdentityError: Microsoft.AspNetCore.Identity.IdentityErrorDescriber
    {
        ...
        public override IdentityError InvalidToken() { return new IdentityError { Code = nameof(InvalidToken), Description = "توکن معتبر نیست." }; }
